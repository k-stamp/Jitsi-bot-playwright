Feature: Lokalisierung HRTF
  ...
  Scenario: Vier Bots joint
    When I pause
    Given Bot 13 navigiert zur Sitzung "raum311"
    Given Bot 14 navigiert zur Sitzung "raum311"
    Given Bot 15 navigiert zur Sitzung "raum311"
    Given Bot 16 navigiert zur Sitzung "raum311"
