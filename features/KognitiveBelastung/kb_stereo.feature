Feature: Fokussierung Stereo
  ...
  Scenario: Acht Bots kognitive Belastung Stereo Audio
    ...
    Given Bot 1201 navigiert zur Sitzung "kevin8"
    Given Bot 1202 navigiert zur Sitzung "kevin8"
    Given Bot 1203 navigiert zur Sitzung "kevin8"
    Given Bot 1204 navigiert zur Sitzung "kevin8"
    Given Bot 1205 navigiert zur Sitzung "kevin8"
    Given Bot 1206 navigiert zur Sitzung "kevin8"
    Given Bot 1207 navigiert zur Sitzung "kevin8"
    Given Bot 1208 navigiert zur Sitzung "kevin8"
