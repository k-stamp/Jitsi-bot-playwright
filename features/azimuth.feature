Feature: Azimuth  Test
  ...
  Scenario: Vier Bots joint
    ...
    Given Bot 3 navigiert zur Sitzung "x55"
    Given Bot 4 navigiert zur Sitzung "x55"
    Given Bot 5 navigiert zur Sitzung "x55"
    Given Bot 6 navigiert zur Sitzung "x55"
    Given Bot 7 navigiert zur Sitzung "x55"
    Given Bot 8 navigiert zur Sitzung "x55"
